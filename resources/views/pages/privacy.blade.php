            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="entry-content hatenablog-entry">
                        ...
                        <h2 class="mt-3 mb-2" id="operator-info">運営者情報</h2>
                        <p>運営者：ikdysk<br>サイトURL：<a href="https://localhost.com/">https://localhost.com/</a><br>お問い合わせ：yusuke.micmic★gmail.com（★を＠に変えてください）</p>

                        <h2 class="mt-3 mb-2" id="usage-purpose">個人情報の利用目的</h2>
                        ...
                        <h2 class="mt-3 mb-2" id="third-party-disclosure">個人情報の第三者への開示</h2>
                        ...
                        <h2 class="mt-3 mb-2" id="information-management">個人情報の管理</h2>
                        <p>個人情報の開示・訂正・追加・削除・利用停止をご希望の場合には、ご本人であることを確認したうえで、速やかに対応致します。</p>

                        <h2 class="mt-3 mb-2" id="about-cookies">Cookieについて</h2>
                        ...
                        <h2 class="mt-3 mb-2" id="advertising-delivery">広告の配信について</h2>
                        ...
                        <h2 class="mt-3 mb-2" id="access-analysis-tools">アクセス解析ツールについて</h2>
                        ...
                        <h2 class="mt-3 mb-2" id="comments-on-site">当サイトへのコメントについて</h2>
                        ...
                        <h2 class="mt-3 mb-2" id="policy-changes">プライバシーポリシーの変更について</h2>
